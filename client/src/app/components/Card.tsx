...
export default function Card({item}: CardProps) {
  ...
  return (
    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow p-4 relative flex flex-col justify-between  gap-2">
      ...
      <p className="bg-orange-950 text-white font-bold mt-2 absolute top-2 right-2 p-4 rounded-full">{item.price} R$</p>

      <button onClick={handleAddToCart}  className="self-end bg-orange-950 hover:bg-[#2b0c04] rounded-md text-white p-2">Adicionar ao carrinho</button>
    </div>
